...
#  STORE_ACCOUNT=jhacker curl_sparql_request --repository "i18n-kanji-1" -H "Accept: application/ld+json" 'query=select%20*%20where%20%20%7b?s%20?p%20?o%7d%20limit%20100000' > test.json
