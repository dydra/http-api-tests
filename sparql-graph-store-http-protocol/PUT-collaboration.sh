...
_:collabaccess <http://www.w3.org/ns/auth/acl#accessTo> <http://dydra.com/account/openrdf-sesame/repository/mem-rdf-write> <http://dydra.com/openrdf-sesame/mem-rdf-write> .
